    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text'    => 'Ambientes',
                    'route'   => 'ambientes.inicio',
                    'icon'    => 'fas fa-fw fa-edit',
                ],
                [
                    'text'    => 'Autenticaciones',
                    'route'   => 'authentications.inicio',
                    'icon'    => 'fas fa-fw fa-edit',
                ],
                [
                    'text'    => 'Bases',
                ...
                [
                    'text'    => 'Criticidad',
                    'route'     => 'criticidad.inicio',
                    'icon'    => 'fas fa-fw fa-edit',
                ],
                [
                    'text' => 'Documentación',
                    'route'  => 'documentations.inicio',
                    'icon'    => 'fas fa-fw fa-edit',
                ],
                [
                    'text'    => 'Estados',
                    'route'     => 'estados.inicio',
                    'icon'    => 'fas fa-fw fa-edit',
                ],
                [
                    'text'    => 'Impacto',
                    'route'     => 'impactos.inicio',
                    'icon'    => 'fas fa-fw fa-edit',
                ],
                [
                    'text' => 'Lenguajes',
                    'route'  => 'lenguajes.inicio',
                    'icon'    => 'fas fa-fw fa-edit',
                ],
                [
                    'text'    => 'Roles',
